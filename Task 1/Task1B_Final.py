...
def applyPerspectiveTransform(input_img):
    ...
    _,imthresh = cv2.threshold(blur,0,255,cv2.THRESH_BINARY+cv2.THRESH_OTSU)
    cv2.imshow("i",imthresh)
    cv2.waitKey(0)
    ...
    warped_img=cv2.warpPerspective(input_img,Homo,(1280,1280))
...
"""
#---------------------------------------------------------------------------------------------------------------------------------------------------
input_img = cv2.imread("F:/Robotics/E-yantra_Comp/Completed E-Yantra_Tasks/E-yantra_Task_1/task_1b_detect_and_encode_maze/task_1b_detect_and_encode_maze/test_cases/maze03.jpg")
#input_img = cv2.imread("C:/Users/hp/Desktop/E-yantra_Comp/Completed E-Yantra_Tasks/E-yantra_Task_1/task_1b_detect_and_encode_maze/task_1b_detect_and_encode_maze/test_cases/maze06.jpg")
